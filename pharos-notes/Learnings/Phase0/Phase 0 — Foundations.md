...
- [[Issue 8 - Debug HUD]] — a canvas-2D FPS/frame-time/draw-call overlay, windowed averaging, factory vs class, closure narrowing into arrows vs hoisted declarations, and the `vite preview` base-path gotcha.
